...
## Экран Disclamer ###################################################################
##
## Этот экран используется в начале игры как предупреждение
##
## 
screen disklamer:
    modal True
    ...
    window:
        ...
        vbox:
            ...
            xalign 0.5
            yalign 0.5
            text "{size=+10}ВНИМАНИЕ{/size}"
            text "Данная игра предназначена для лиц, достигших 18 лет с устойчивой психикой." 
            text "По ходу игры вы столкнетесь со сценами физическиго и психологического насилия, употребления веществ, азартными играми, ненормативной лексикой. " 
            text "Так же присутствуют сцены эротического содержания, в том числе, которые вам вероятно не понравятся, нетрадиционные отношения и т.п."
            text "По ходу игры вы можете попасть в токсичные отношения, столкнуться с дискриминацией, суицидом и пр."
            null      
            text "{size=+7}Для непонятливых:{/size}"   
            text "Любые оскорбительные или неприятные сцены соответсвуют художественному замыслу, относятся только к вымышленным персонажам и событиям, ни к чему не призывают и не несут цели оскорбить лично тебя, твою религию или твою кошку." 
            text "Так что если ты из этих всяких, просто нажми крестик в правом верхнем углу."   
            null
            text "Если тебя все устраивает, то добро пожаловать." 
            
            hbox: 
                xalign 0.5 yalign 0.95
                textbutton "ОК" action Hide("disklamer") 
                textbutton "ЗАКРЫТЬ ИГРУ" action [Hide("letter"), Quit()] 

style disklamer_text:
    color "#e40303"
    size 20
    xalign 0.5
    #font "DejaVuSans.ttf"
