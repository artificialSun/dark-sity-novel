...
default my_type = "man" #параметр используется для подбора картинки в зависимости от выбора персонажа. me man - молодой мужчина, oldman - пожилой мужчина
...
###### Многослойные изображения для ГГ и функция отображения
init:
    image empty_me = Null(300, 600)
    ...
    layeredimage me man:
        ...
        group img:
            attribute dressed: 
                "images/me/me man normal.png"
            attribute nu: 
                "images/me/me man nu.png"
            attribute big: 
                "images/me/me man big.png"

    layeredimage me oldman:
        always: 
            "empty_me"
        group img:
            attribute dressed: 
                "images/me/me oldman normal.png"
            attribute nu: 
                "images/me/me oldman nu.png"
            attribute big: 
                "images/me/me oldman big.png"     

init python:
    def show_me(attr = "normal", where = left):
        renpy.show("me "+my_type+" "+attr, at_list=[where])
###################################   

default my_av_zp = 0 #средняя зарплата, станет больше 0 после того, как персонаж сходит на работу
# какие мини-игры может пропускать персонаж
...
########################################################################################################################################################################
####################################### Другие персонажи игры ##########################################################################################################
########################################################################################################################################################################
#======= перенести в соответствующие блоки
...
define pokupatel = Character(_('Покупатель'), color="#55ebff", image='juli') #Джулия девушка из казино
