...
define gui.dialogue_ypos = 49

## Максимальная ширина текста диалога в пикселях.
define gui.dialogue_width = 722
...
define gui.choice_button_width = 766
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(97, 5, 97, 5)
...
define gui.slot_button_width = 268
...
define config.thumbnail_width = 249
...
define gui.confirm_frame_borders = Borders(39, 39, 39, 39)

## Рамки, используемые в частях экрана пропуска.
define gui.skip_frame_borders = Borders(16, 5, 49, 5)

## Рамки, используемые в частях экрана уведомлений.
define gui.notify_frame_borders = Borders(16, 5, 39, 5)
...
define gui.history_text_xpos = 165
define gui.history_text_ypos = 2
define gui.history_text_width = 718
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(39, 14, 39, 0)
    ...
    def small():
        ...
        gui.textbox_height = 233
        gui.name_xpos = 78
        gui.dialogue_xpos = 88
        gui.dialogue_width = 1067

        ## Изменяет размеры и интервалы различных объектов.
        gui.slider_size = 35

        gui.choice_button_width = 1203
        gui.choice_button_text_size = 30

        gui.navigation_spacing = 20
        gui.pref_button_spacing = 10

        gui.history_height = 185
        gui.history_text_width = 669
        ...
        gui.nvl_name_width = 296
        gui.nvl_name_xpos = 316

        gui.nvl_text_width = 888
        gui.nvl_text_xpos = 335
        gui.nvl_text_ypos = 5

        gui.nvl_thought_width = 1203
        gui.nvl_thought_xpos = 20

        gui.nvl_button_width = 1203
